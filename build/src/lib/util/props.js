 ...
 * @param options
 */
export async function loadTemplates({ config, viewxTemplates, templates, setTemplates, setUI, ui, layers, Functions, functionContext }) {
...
export function getTemplatePaths(viewxTemplates) {
...
export async function loadDynamicTemplate({ config, viewxTemplates, templates, setTemplates, setUI, ui, layers, Functions, functionContext, pathname, }) {
    const fetchFunction = (Functions.fetchJSON || fetchJSON).bind(functionContext);
...
export function hasMatchingDynamicTemplateRoutePathFallback({ viewxTemplates, layers, pathname, }) {
...
export async function loadRoute({ ui, viewxTemplates, pathname, dispatcher, layers, Functions, functionContext, resourceprops = {} }) {
 ...
 */
export function getFunctionFromNameString({ Functions, functionContext, functionName }) {
    let func;
    try {
