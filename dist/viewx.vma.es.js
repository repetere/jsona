...
function getAdvancedBinding() {
  ...
  if (typeof window === 'undefined') {
    var window = (this && this.window)
      ? this.window
      : (typeof global$1!=="undefined" ? global$1 : window).window || {};
...
function getFunctionFromProps(options) {
  ...
  const windowObject = this.window || (typeof global$1!=="undefined" ? global$1 : window).window || {};
  try {
...
function getMainComponent(options) {
    ...
    function Main(appProps) {
        ...
        return (React.createElement(Fragment, null, options.config.layers.map(function (layer) {
            var name = layer.name, type = layer.type;
...
function getGlobalStateHooks(options) {
    ...
    var _a = createStore(reducer, initialState), GlobalStateProvider = _a.GlobalStateProvider, dispatch = _a.dispatch, useGlobalState = _a.useGlobalState;
    return {
